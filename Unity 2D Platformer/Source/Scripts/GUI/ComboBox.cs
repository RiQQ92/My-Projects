...
public class ComboBox
{
	...
	public int Show()
	{
		...
		if( isClickedComboButton )
		{
			...
			Rect selectedRect = new Rect(rect.x, rect.y + listStyle.CalcHeight(listContent[0], 1.0f) * (selectedItemIndex+1),
			                             rect.width, listStyle.CalcHeight(listContent[0], 1.0f));


			GUI.Box( listRect, "", boxStyle );
			GUI.Box( selectedRect, "", boxStyle);
